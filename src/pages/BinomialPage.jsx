          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '26px', maxWidth: '694px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              {[
                ...
                'The engagement required designing the full product from the ground up: brand identity, logo, a marketing website, and a responsive web application covering five core sections - with no prior design system and a technically novel restaking domain that had no established UX conventions to reference.',
              ].map((para, i) => (
      ...
      {activeTab === 'Problem' && (
        <>
          <div style={contentBlock}>
            ...
            <div style={{ ...bodyText, color: textPrimary, display: 'flex', flexDirection: 'column', gap: '40px' }}>
              <p style={{ margin: 0 }}>The interface was the straightforward part. The real challenge was making a novel financial mechanism legible without oversimplifying it.</p>
