        ...
        <main className="page-enter" style={{ flex: 1, padding: '32px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start', gap: '24px' }}>
            ...
            <>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '26px', maxWidth: '694px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '40px', ...bodyText, color: textPrimary }}>
                  ...
                  <p style={{ margin: 0 }}>
                    The platform serves three distinct user types — admins, content creators, and learners — each with fundamentally different goals, mental models, and levels of technical fluency.
                  </p>
                  <p style={{ margin: 0 }}>
            ...
            <>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '694px' }}>
                ...
                <div style={{ ...bodyText, color: textPrimary, display: 'flex', flexDirection: 'column', gap: '40px' }}>
                  <p style={{ margin: 0 }}>
                    Designing a multi-stakeholder platform where complexity is the product.
                  </p>
                  <p style={{ margin: 0 }}>
          ...
          {activeTab === 'Problem' && (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '694px' }}>
              ...
              <div style={{ ...bodyText, color: textPrimary, display: 'flex', flexDirection: 'column', gap: '40px' }}>
                <p style={{ margin: 0 }}>
                  The hardest problem wasn't the interface. It was reducing invisible friction.
                </p>
                <p style={{ margin: 0 }}>
                ...
                <p style={{ margin: 0 }}>
                  The parallel challenge on the creator side was structural: instructors needed a multi-step course creation flow guided enough for first-time publishers but flexible enough for power users managing large catalogues.
                </p>
                <p style={{ margin: 0 }}>
                  Both problems were versions of the same root issue - users encountering system complexity at exactly the moment they needed to feel in control. The design had to absorb that complexity so users did not have to.
                </p>
              </div>
            </div>
            </>
            ...
            <>
              ...
              <a
                ...
                style={{
                  ...
                  color: '#005AFF', textDecoration: 'none',
                }}
              >
                Research Data
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '694px' }}>
                ...
                <ol style={{ margin: 0, paddingLeft: '24px', listStyleType: 'decimal', display: 'flex', flexDirection: 'column', gap: '32px', ...bodyText, color: textPrimary }}>
                  <li>
                    Establishing an Initial Action Plan — Rather than designing top-to-bottom by product scope, I mapped user journeys against pain severity and business impact. This prioritisation directed early effort toward the highest-risk flows rather than the most visible pages.
                  </li>
                  <li>
                    Discovery Stakeholder interviews surfaced competing priorities between business goals and user needs. User group sessions with prospective learners and instructors revealed a consistent pattern: both groups were willing to engage with unfamiliar interaction models — but only if the path felt guided rather than technical.
                  </li>
                  <li>
                    Competitive Analysis Benchmarked against both conventional (Udemy, Teachable, Coursera) and Web3-native (Rabbithole, Mirror) platforms to identify gaps in onboarding clarity, content creation flow, and certificate management.
                  </li>
                  <li>
                    Information Architecture Mapped the full IA for all three user types before any UI work began. This step surfaced flow conflicts between creator and learner journeys that would have been expensive to resolve at prototype stage.
                  </li>
                  <li>
                    Wireframes and Prototype — Maintained low fidelity longer than stakeholders were comfortable with. Pressure to move to visual design came early. Holding at lo-fi through two additional structural feedback rounds prevented significant rework and kept the team focused on behaviour, not appearance.
                  </li>
                  <li>
                    Usability Testing Two rounds: the first with a wireframe prototype targeting structural comprehension, the second with the high-fidelity prototype targeting confidence and error recovery at the highest-risk interactions - wallet connection, course creation step three, and certificate issuance.
                  </li>
                  <li>
                    Dev Collaboration and QA Weekly design critique sessions with engineers were introduced mid-project. In four sessions, technically complex interactions were identified before they reached the spec stage. This became a standing practice for the remainder of the engagement and removed the most common source of late-stage rework.
                  </li>
                </ol>
              </div>
            </>
          ...
          {activeTab === 'Key Decisions' && (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '694px' }}>
              ...
              <div style={{ ...bodyText, color: textPrimary, display: 'flex', flexDirection: 'column', gap: '40px' }}>
                <p style={{ margin: 0 }}>
                  Start from the most painful page, not the most visible one. The client prioritised the homepage.
                </p>
                <p style={{ margin: 0 }}>
            ...
            <>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '694px' }}>
                ...
                <div style={{ ...bodyText, color: textPrimary, display: 'flex', flexDirection: 'column', gap: '40px' }}>
                  ...
                  <p style={{ margin: 0 }}>
                    The final solution was a component-driven product covering six core user journeys across three user types, built on a shared design system.
                  </p>
                  <p style={{ margin: 0 }}>
                    Guided Onboarding - Progressive wallet connection flow with a fallback path for users without an existing wallet, a personalisation step before any monetisation touchpoint, and contextual guidance surfaced at every friction-prone interaction.
                  </p>
                  <p style={{ margin: 0 }}>
                    Multi-Step Course Creation<br />
                  ...
                  <p style={{ margin: 0 }}>
                    Certificate Template Builder<br />
                  ...
                  <p style={{ margin: 0 }}>
                    Course Discovery and Moderation<br />
                  ...
                  <p style={{ margin: 0 }}>
                    Marketing and Content Pages - Content-driven landing page and blog architecture aligned to acquisition and SEO goals, built from the same component library as the product.
                  </p>
                </div>
              </div>
            </>
