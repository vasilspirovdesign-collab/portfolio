        ...
        <div style={contentBlock}>
          ...
          <div style={{ ...bodyText, color: textPrimary, display: 'flex', flexDirection: 'column', gap: '40px' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: '24px', listStyleType: 'disc', display: 'flex', flexDirection: 'column', gap: '8px' }}>
              ...
              <li><strong>Isogonal Admin</strong> — a full operations console covering user management, fund review, Segregated Portfolio configuration, document generation, AIFM submission coordination, funding confirmation, and token issuance across the full platform</li>
