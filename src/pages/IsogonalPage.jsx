...
import isoqDecisions from '../assets/iso-q-decisions.png'
import isoqLearned from '../assets/iso-q-learned.png'
    ...
    >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '26px', maxWidth: '694px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            {[
              ...
              'The scope covered the full platform lifecycle: information architecture across five role contexts, fifteen mapped use cases, multi-step onboarding wizards, document generation and review flows, NAV data management, KYC/AML integration, tokenization preference selection, Segregated Portfolio configuration, and an admin console - delivered as a complete UX, UI, and design system package.',
            ].map((para, i) => (
        ...
        <>
          ...
          <div style={contentBlock}>
            ...
            <div style={{ ...bodyText, color: textPrimary, display: 'flex', flexDirection: 'column', gap: '40px' }}>
              ...
              <p style={{ margin: 0 }}>Unlike platforms where user types operate in separate lanes, ISO-Q&apos;s five roles operate on the same data simultaneously - an Asset Manager&apos;s fund configuration determines what an Investor can subscribe to, which determines what the AIFM reviews, which determines when the Admin can confirm funding. The challenge was designing five separate experiences that produced one coherent operational system.</p>
      ...
      {activeTab === 'Problem' && (
        <div style={contentBlock}>
          ...
          <div style={{ ...bodyText, color: textPrimary, display: 'flex', flexDirection: 'column', gap: '40px' }}>
            <p style={{ margin: 0 }}>Making five different users feel in control of the same regulated process - simultaneously - was the design problem.</p>
            <p style={{ margin: 0 }}>Private fund investment is structurally complex before any platform layer is added. Asset Managers are configuring legal and financial structures. Investors are making multi-million dollar commitments through choices most platforms don&apos;t explain clearly. The AIFM is approving structures that must meet regulatory thresholds before any subscription can proceed. The platform admin is coordinating all of them at once.</p>
      ...
      {activeTab === 'Key Decisions' && (
        <>
          <div style={photoCard(dark)}>
            <img src={isoqDecisions} alt="Key Decisions" loading="lazy" style={photoImg} />
          </div>
          <div style={contentBlock}>
      ...
      {activeTab === 'Solution' && (
        <div style={contentBlock}>
          ...
          <div style={{ ...bodyText, color: textPrimary, display: 'flex', flexDirection: 'column', gap: '40px' }}>
            ...
            <p style={{ margin: 0 }}>Fifteen use cases. Five role contexts. One platform that had to hold them all in a coherent operational sequence. The delivered product covered the full fund investment lifecycle - from platform initialisation through AIFM approval and token issuance - built on an institutional-grade design system with role-specific navigation, compliance-first interaction patterns, and complete save-and-resume capability across all multi-step flows.</p>
      ...
      {activeTab === "Things I've learned.." && (
        <>
          <div style={photoCard(dark)}>
            <img src={isoqLearned} alt="Things I've learned" loading="lazy" style={photoImg} />
          </div>
          <div style={contentBlock}>
