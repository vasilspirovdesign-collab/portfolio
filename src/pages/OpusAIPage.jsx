          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '26px', maxWidth: '694px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              {[
                ...
                'The engagement required designing an AI agent that felt native to the product rather than bolted on - context-aware, action-capable, and visually integrated with the existing OpusEdu interface across both desktop and mobile, without disrupting the flows it was built to support.',
              ].map((para, i) => (
        ...
        <>
          ...
          <div style={contentBlock}>
            ...
            <ul style={{ margin: 0, paddingLeft: '24px', listStyleType: 'disc', display: 'flex', flexDirection: 'column', gap: '32px', ...bodyText, color: textPrimary }}>
              <li><strong>AI features fail when they&apos;re designed as features rather than as extensions of existing flows.</strong> Early in the project I designed the assistant as a self-contained interface. When mapped against the actual user journeys, it became clear that the assistant&apos;s value was entirely dependent on where it appeared and what it knew about the user&apos;s current state. Redesigning around contextual integration rather than standalone functionality changed the product significantly - and made it substantially more useful.</li>
